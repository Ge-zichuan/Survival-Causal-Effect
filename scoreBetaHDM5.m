function [scoreVal,checkerror] = scoreBetaHDM5(parasLower,xall1,zdiffall1,deltaall1,kbz1,...
...
scoreVal = sum(scoreValallsub1,1);
...
scoreVal = (scoreVal+sum(scoreValallsub0,1))/(samplesize1+samplesize0);
% scoreVal = (scoreVal+sum(scoreValallsub0,1));
checkerror = [checkError1,checkError0(:,2)];
end